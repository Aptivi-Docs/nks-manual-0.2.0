...
You can follow the instructions on how to get extra addons here.

{% content-ref url="obtaining-extra-addons.md" %}
[obtaining-extra-addons.md](obtaining-extra-addons.md)
{% endcontent-ref %}
